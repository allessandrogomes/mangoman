...
export const WhereAreWe = forwardRef<HTMLElement, IWhereAreWe>(
  ({ localization }, ref) => {
    return (
      <SectionLayout id="where" className="mb-[200px]" ref={ref}>
        <HeaderSection
          title={localization.title ?? 'Where are we'}
          subtitle={
            localization.subtitle ??
            'Head office, facilitating access and customer service'
          }
          titleColor="primary"
        />
