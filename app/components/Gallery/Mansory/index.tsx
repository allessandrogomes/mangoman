...
const Masonry: React.FC<MasonryProps> = ({
    ...
    const { grid, height: containerHeight } = useMemo(() => {
    ...
    useEffect(() => {
        if (containerHeight && onHeightChange) {
    ...
    return (
        <div ref={containerRef} className="relative w-full" style={{ height: containerHeight }}>
            {grid.map(item => (
                ...
                >
                    <div
                        className="relative cursor-pointer w-full h-full bg-cover bg-center rounded-[10px] shadow-[0px_10px_50px_-10px_rgba(0,0,0,0.2)] uppercase text-[10px] leading-[10px]"
